...
from .models import Affect, Flaw, FlawComment, Tracker
...
class FlawCommentView(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        flaw_uuid = self.get_flaw().uuid

        # Lock the flaw to minimize concurrency in bulk POST operation.
        # See the comment in FlawComment.Meta.constraints for details.
        Flaw.objects.select_for_update().get(uuid=flaw_uuid)
